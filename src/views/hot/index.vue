<template>
  <div class="goods-list-container">
    ...
    <el-table :data="tableData" border style="width: 100%">
      <el-table-column fixed prop="hotGoodsId" label="商品ID" width="100">
      </el-table-column>
      <el-table-column prop="hotGoodsName" label="商品名称" width="150">
      </el-table-column>
      <el-table-column prop="hotGoodsNumber" label="商品数量" width="100">
      </el-table-column>
      <el-table-column prop="hotGoodsPrice" label="商品价格" width="100">
      </el-table-column>
      <el-table-column label="商品状态" width="100">
        <template slot-scope="scope">
          {{ scope.row.hotGoodsStatus | goodsStatusFilter }}
        </template>
      </el-table-column>
      <el-table-column prop="hotGoodsDetails" label="商品详情" width="150">
      </el-table-column>
      <el-table-column prop="hotGoodsAddress" label="商品地址" width="150">
      </el-table-column>
    ...
    <el-dialog title="商品信息" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="商品ID" :label-width="formLabelWidth">
          <el-input v-model="form.hotGoodsId" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="商品名称" :label-width="formLabelWidth">
          <el-input v-model="form.hotGoodsName" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="商品数量" :label-width="formLabelWidth">
          <el-input v-model="form.hotGoodsNumber" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="商品价格" :label-width="formLabelWidth">
          <el-input v-model="form.hotGoodsPrice" autocomplete="off"></el-input>
        </el-form-item>
...
<script>
import { hotGoodsList, deleteHotGoods } from "@/api/goods";
export default {
  activated() {
    const data = {
      pageNum: 1,
  ...
  methods: {
    ...
    handleDelete(data) {
      ...
      deleteHotGoods(data.hotGoodsId).then((res) => {
        console.log("删除商品成功");
        getList();
      });
    },
