    ...
    <el-dialog title="用户信息" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="id" :label-width="formLabelWidth">
          <el-input v-model="form.buyerId" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="昵称" :label-width="formLabelWidth">
          <el-input v-model="form.buyerName" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="密码" :label-width="formLabelWidth">
          <el-input v-model="form.buyerPassword" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="联系方式" :label-width="formLabelWidth">
          <el-input v-model="form.buyerPhone" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="地址" :label-width="formLabelWidth">
          <el-input v-model="form.buyerAddress" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
...
<script>
import { list, searchUser, deleteUser, updateBuyer } from "@/api/storeUser";
export default {
  activated() {
    const data = {
      pageNum: 1,
  ...
  methods: {
    ...
    update() {
      this.loading = true;
      updateBuyer(this.form).then((res) => {
